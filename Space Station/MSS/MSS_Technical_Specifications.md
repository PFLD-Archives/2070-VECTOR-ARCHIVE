...
* **Primary Power Plant:** S.F.R. Mark II (Low-Yield / Type-B)
    * **Description:** A specialized variant of the Synthetic Fusion Reactor tuned for kinetic output and rapid shield regeneration. While it lacks the raw output for planetary destruction, it provides the massive energy bursts required for frequent FTL maneuvers.
...
### V. CAVEATS DATA
 * Frequent short-range FTL jumps cause thermal stress on the Type-B Reactor; manual coolant flushes are required every 48 hours.
 * The Phalanx Saturation Projector requires a significant recharge period after a full-sector burst, leaving the station reliant on its ablative shielding for 300 seconds post-fire.
